...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $teacher_status = $_POST['staff_status'];
    ...
    $query = "INSERT INTO staff_info (first_name, middle_name, last_name, father_name, email, phone_no, staff_status, application_status, dob, other_phone, gender, permanent_address, current_address, place_of_birth, last_qualification, state, hire_date)
