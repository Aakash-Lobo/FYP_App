...
// if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT LeaveType, ToDate, FromDate, Description, PostingDate, AdminRemarkDate, AdminRemark, Status FROM tblleaves WHERE empid = (SELECT staff_id FROM staff_info WHERE email = ?)";
