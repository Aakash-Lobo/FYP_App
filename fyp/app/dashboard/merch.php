...
try {
    ...
    $sqlCategory = "SELECT COUNT(*) AS 'Total Categories' FROM merch_categories";
    ...
    $sqlCompany = "SELECT COUNT(*) AS 'Total Orders' FROM merch_orders";
    ...
    $sqlJob = "SELECT COUNT(*) AS 'Total Products' FROM merch_product";
