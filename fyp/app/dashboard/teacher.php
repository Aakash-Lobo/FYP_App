...
try {
    ...
    $sqlCategory = "SELECT COUNT(*) AS 'Total Teachers' FROM teacher_info";
    $resultCategory = mysqli_query($con, $sqlCategory);
    $categoryCount = mysqli_fetch_assoc($resultCategory);
    $categoryCount = intval($categoryCount['Total Teachers']); // Convert to integer
