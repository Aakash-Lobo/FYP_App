...
$query = "SELECT * FROM class_result cr INNER JOIN course_subjects cs ON cr.subject_code = cs.subject_code WHERE cr.roll_no = (SELECT roll_no FROM student_info WHERE email = '$username') AND cr.semester = 5";
