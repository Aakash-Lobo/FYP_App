...
import 'package:flutter_application_1/Modules/Merch/ViewMenuPage.dart';
import 'package:flutter_application_1/Modules/Merch/ViewOrderCategory.dart';
import 'package:flutter_application_1/Modules/Merch/ViewOrderPage.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class MerchHomePage extends StatefulWidget {
  final String username;

  MerchHomePage({required this.username});

  @override
  _ChefHomePageState createState() => _ChefHomePageState();
}

class _ChefHomePageState extends State<MerchHomePage> {
  ...
  Future<void> fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/fyp/app/dashboard/merch.php'));
