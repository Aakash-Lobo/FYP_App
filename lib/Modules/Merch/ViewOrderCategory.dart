...
import 'package:flutter_application_1/Modules/Merch/AddOrderCategoryPage.dart';
  ...
  Future<void> _fetchCategories() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost/fyp/app/modules/merch/viewcategory.php'),
      );
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    'http://localhost/fyp/app/modules/merch/Images/pizza-' +
