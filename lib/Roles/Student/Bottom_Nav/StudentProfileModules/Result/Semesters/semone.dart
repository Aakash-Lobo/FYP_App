...
class SemesterOneResult extends StatefulWidget {
  final String username;

  SemesterOneResult({required this.username});

  @override
  _SemesterTwoResultState createState() => _SemesterTwoResultState();
}

class _SemesterTwoResultState extends State<SemesterOneResult> {
  ...
  Future<void> fetchData() async {
    final url = Uri.parse(
        'http://localhost/fyp/app/student/Bottom/result/semone.php?username=${widget.username}');
