...
class SemesterTwoResult extends StatefulWidget {
  final String username;

  SemesterTwoResult({required this.username});

  @override
  _SemesterTwoResultState createState() => _SemesterTwoResultState();
}

class _SemesterTwoResultState extends State<SemesterTwoResult> {
  ...
  Future<void> fetchData() async {
    final url = Uri.parse(
        'http://localhost/fyp/app/student/Bottom/result/semtwo.php?username=${widget.username}');
