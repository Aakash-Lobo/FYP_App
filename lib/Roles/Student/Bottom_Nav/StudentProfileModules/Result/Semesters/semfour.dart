...
class SemesterFourResult extends StatefulWidget {
  final String username;

  SemesterFourResult({required this.username});

  @override
  _SemesterTwoResultState createState() => _SemesterTwoResultState();
}

class _SemesterTwoResultState extends State<SemesterFourResult> {
  ...
  Future<void> fetchData() async {
    final url = Uri.parse(
        'http://localhost/fyp/app/student/Bottom/result/semfour.php?username=${widget.username}');
