...
class SemesterSixResult extends StatefulWidget {
  final String username;

  SemesterSixResult({required this.username});

  @override
  _SemesterTwoResultState createState() => _SemesterTwoResultState();
}

class _SemesterTwoResultState extends State<SemesterSixResult> {
  ...
  Future<void> fetchData() async {
    final url = Uri.parse(
        'http://localhost/fyp/app/student/Bottom/result/semsix.php?username=${widget.username}');
