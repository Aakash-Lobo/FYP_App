...
class SemesterThreeResult extends StatefulWidget {
  final String username;

  SemesterThreeResult({required this.username});

  @override
  _SemesterTwoResultState createState() => _SemesterTwoResultState();
}

class _SemesterTwoResultState extends State<SemesterThreeResult> {
  ...
  Future<void> fetchData() async {
    final url = Uri.parse(
        'http://localhost/fyp/app/student/Bottom/result/semthree.php?username=${widget.username}');
