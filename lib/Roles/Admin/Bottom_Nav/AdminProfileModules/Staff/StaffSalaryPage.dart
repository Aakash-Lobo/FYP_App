...
class AddStaffSalaryPage extends StatefulWidget {
  final String username;

  AddStaffSalaryPage({required this.username});

  @override
  _AddStaffSalaryPageState createState() => _AddStaffSalaryPageState();
}

class _AddStaffSalaryPageState extends State<AddStaffSalaryPage> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://localhost/fyp/app/admin/profile/staff/addsalary.php'),
        body: {
          'staff_id': teacherId,
        },
      );
  ...
  Future<void> _fetchSalaryData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://localhost/fyp/app/admin/profile/staff/viewsalary.php'),
      );
      if (response.statusCode == 200) {
