...
import 'package:flutter_application_1/Roles/Admin/Bottom_Nav/AdminProfileModules/Staff/StaffLeavePage.dart';
import 'package:flutter_application_1/Roles/Admin/Bottom_Nav/AdminProfileModules/Staff/StaffSalaryPage.dart';
import 'package:flutter_application_1/Roles/Admin/Bottom_Nav/AdminProfileModules/Staff/ViewStaffPage.dart';
...
class AdminStaff extends StatefulWidget {
  ...
  @override
  _AdminStaffState createState() => _AdminStaffState();
}
...
class _AdminStaffState extends State<AdminStaff> {
  ...
  Future<void> fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/fyp/app/dashboard/staff.php'));
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ViewStaffLeavePage(username: username),
                ),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AddStaffSalaryPage(username: username),
                ),
              );
            },
          ),
