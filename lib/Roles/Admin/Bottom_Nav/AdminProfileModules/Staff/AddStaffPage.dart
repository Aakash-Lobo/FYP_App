...
class _AddStaffPageState extends State<AddStaffPage> {
  ...
  void _submitForm() async {
    ...
    final response = await http.post(
      Uri.parse("http://localhost/fyp/app/admin/profile/staff/addstaff.php"),
      body: {
        ...
        'staff_status': selectedTeacherStatus ?? '',
    ...
    if (response.statusCode == 200) {
      ...
      if (result['message'] == 'Staff added successfully') {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
              builder: (context) => AdminStaff(username: widget.username)),
        );
      } else {
        // Error in submission
