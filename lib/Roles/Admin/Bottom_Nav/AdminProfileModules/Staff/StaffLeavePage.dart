...
class ViewStaffLeavePage extends StatefulWidget {
  final String username;

  ViewStaffLeavePage({required this.username});

  @override
  _ViewStaffLeavePageState createState() => _ViewStaffLeavePageState();
}

class _ViewStaffLeavePageState extends State<ViewStaffLeavePage> {
  ...
  Future<void> _fetchLeaveData() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost/fyp/app/admin/profile/staff/viewleave.php'),
      );
