...
class StaffLeavePage extends StatefulWidget {
  ...
  @override
  _StaffLeavePageState createState() => _StaffLeavePageState();
}
...
class _StaffLeavePageState extends State<StaffLeavePage> {
  ...
  void submitForm() async {
    final response = await http.post(
      Uri.parse('http://localhost/fyp/app/staff/Bottom/leave/applyleave.php'),
      body: {
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => StaffLeaveHistory(username: username),
                ),
              );
            },
          ),
