...
import 'package:flutter_application_1/Roles/Common/Merch/MerchCartPage.dart';
import 'package:flutter_application_1/Roles/Common/Merch/MerchOrderPage.dart';
...
class _StudentMerchPageState extends State<StudentMerchPage> {
  ...
  Future<void> fetchProducts() async {
    final response = await http
        .get(Uri.parse('http://localhost/fyp/app/modules/merch/viewmenu.php'));
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(
                        'assets/PortalBanner/merch.jpg'), // Placeholder image
                    fit: BoxFit.fill,
                  ),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => ProductDetailPage(
                              ...
                              imageUrl:
                                  'http://localhost/fyp/app/modules/merch/Images/pizza-${product['productId']}.jpg',
                            ),
                          ),
                        );
                      },
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MerchOrderPage(username: username),
                ),
              );
            },
          ),
